    ...
    <%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %>
        <%@ taglib uri="http://java.sun.com/jsp/jstl/fmt" prefix="fmt" %>
            ...
            <body>
                ...
                <div class="container mt-5 modifyCon d-flex justify-content-center">
                    <table class="signupTable">
                        ...
                        <form id="signInForm" action="join" method="post">
                            ...
                            <tr>
                                ...
                                <td>
                                    시/도
                                    <select id="sido_name" class="adress" name="input_sido_name">
                                        <option>선택하세요</option>
                                    ...
                                    시/군/구
                                    <select id="sigungu_name"  class="adress" name="input_sigungu_name">
                                        <option>선택하세요</option>
                                    </select>
                                    읍/면/동
                                    <select id="dong_name"  class="adress" name="input_dong_name">
                                        <option>선택하세요</option>
                                    </select>
                                </td>
                            </tr>
                            <tr class="joinBtn d-flex justify-content-center mt-5">
