...
<html>
  ...
  <body>
    <div
      ...
      style="width: 1200px; max-width: none !important"
    >
      <div class="row headerrow">
        <div class="col-2 tomatoCol">
          <a href="/tomato/"
            ><img
              ...
              onerror="this.src='img/tomatoLogo.jpg'"
              class="img-rounded tomatologo"
              alt="토마토"
              width="80px"
              height="80px"
          /></a>
        ...
        <div class="col-8 searchCol" style="width: 785px; padding-top: 20px">
          <form class="d-flex align-self-center" role="search">
            <input
              class="form-control me-2 searchWrite"
              type="search"
              placeholder="입력해주세요"
              aria-label="Search"
        ...
        <div class="col-1 LoginCol" style="width: 110px">
          <a
            href="http://localhost:8282/tomato/auth/login"
            class="btn btn-outline-success btn-sm Login"
            tabindex="-1"
            role="button"
            aria-disabled="true"
      ...
      <div class="row navrow">
        ...
        <div class="col-3 emptySpace" style="width: 400px"></div>
        <div class="col-1 writeLog">
          <a href="#"
            ><img
              src="../img/writeIcon.png"
              onerror="this.src='img/writeIcon.png'"
              class="img-fluid"
              alt="쓰기"
          /></a>
        </div>
        <div class="col-1 chatLogo">
          <a href="#"
            ><img
              ...
              onerror="this.src='img/chatIcon.png'"
              class="img-fluid"
              alt="채팅"
          /></a>
        </div>
        <div class="col-1 heartLogo">
          <a href="#"
            ><img
              ...
              onerror="this.src='img/heartIcon.png'"
              class="img-fluid"
              alt="찜"
          /></a>
        </div>
